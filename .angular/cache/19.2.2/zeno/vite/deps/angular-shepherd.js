...
var arrow$1 = (options) => ({
  ...
  fn(state) {
    return __async(this, null, function* () {
      ...
      const arrowDimensions = yield platform2.getDimensions(element2);
      ...
      const arrowOffsetParent = yield platform2.getOffsetParent == null ? void 0 : platform2.getOffsetParent(element2);
...
var getElementRects = function getElementRects2(data) {
  return __async(this, null, function* () {
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  return [element2, dataStepId, descriptionId, labelId, step, hasCancelIcon, hasTitle, handleKeyDown, firstFocusableElement, focusableElements, lastFocusableElement, classPrefix, getElement, dialog_binding];
}
    ...
    return __async(this, null, function* () {
      if (this.options.confirmCancel) {
        ...
        if (isFunction(this.options.confirmCancel)) {
          stopTour = yield this.options.confirmCancel();
        } else {
...
// node_modules/angular-shepherd/fesm2022/angular-shepherd.mjs
function elementIsHidden(element2) {
...
var ShepherdService = class _ShepherdService {
  ...
  requiredElementsPresent() {
    ...
    this.requiredElements.forEach((element2) => {
      const selectedElement = document.querySelector(element2.selector);
      if (allElementsPresent && (!selectedElement || elementIsHidden(selectedElement))) {
        allElementsPresent = false;
        this.errorTitle = element2.title;
        this.messageForUser = element2.message;
      }
    });
