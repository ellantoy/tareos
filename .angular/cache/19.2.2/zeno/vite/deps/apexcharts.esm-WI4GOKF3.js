  ...
  return s(t2, [{
    ...
    value: function(t3) {
      ...
      if (i2.globals.seriesGroups.forEach(function(t4) {
        ...
        var L2 = new Mi(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({
          realIndex: n2,
          j: r2
        }), g2.fontSize);
...
var qa = function() {
  ...
  return s(t2, [{
    ...
    value: function(t3, e2) {
      ...
      }), h2 > 0 && (l2 && console.warn("Chart or series type ".concat(l2, " cannot appear with other chart or series types.")), n2.column.series.length > 0 && s2.plotOptions.bar.horizontal && (h2 -= n2.column.series.length, n2.column = {
        series: [],
        i: []
...
apexcharts/dist/apexcharts.esm.js:
  ...
  *)
*/
//# sourceMappingURL=apexcharts.esm-WI4GOKF3.js.map
