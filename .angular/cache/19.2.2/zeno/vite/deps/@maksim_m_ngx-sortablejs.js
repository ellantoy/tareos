...
// node_modules/@maksim_m/ngx-sortablejs/fesm2020/maksim_m-ngx-sortablejs.mjs
...
var SortablejsBinding = class {
  ...
  get(index2) {
    return this.isFormArray ? this.target.at(index2) : this.target[index2];
  }
  remove(index2) {
    let item;
    if (this.isFormArray) {
...
var SortablejsService = class {
};
SortablejsService.ɵfac = function SortablejsService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SortablejsService)();
};
...
var SortablejsDirective = class {
  ...
  ngOnInit() {
    if (sortable_esm_default && sortable_esm_default.create) {
      this.create();
    }
  }
  ngOnChanges(changes) {
  ...
  get optionsWithoutEvents() {
    return __spreadValues(__spreadValues({}, this.globalConfig || {}), this.sortablejsOptions || {});
  }
...
SortablejsDirective.ɵfac = function SortablejsDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SortablejsDirective)(ɵɵdirectiveInject(GLOBALS, 8), ɵɵdirectiveInject(SortablejsService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(Renderer2));
};
...
SortablejsModule.ɵfac = function SortablejsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || SortablejsModule)();
};
SortablejsModule.ɵmod = ɵɵdefineNgModule({
  type: SortablejsModule,
  declarations: [SortablejsDirective],
  exports: [SortablejsDirective]
});
SortablejsModule.ɵinj = ɵɵdefineInjector({});
(() => {
...
sortablejs/modular/sortable.esm.js:
   ...
   *)
*/
//# sourceMappingURL=@maksim_m_ngx-sortablejs.js.map
