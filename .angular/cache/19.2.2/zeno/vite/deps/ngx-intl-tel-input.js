          ...
          (function(global) {
            (function() {
              ...
              $jscomp.arrayIterator = function(a2) {
                return {
                  next: $jscomp.arrayIteratorImpl(a2)
                };
              };
              ...
              $jscomp.polyfillUnisolated = function(a2, b2, c2, d2) {
                ...
                d2 = c2[a2];
                b2 = b2(d2);
                b2 != d2 && null != b2 && $jscomp.defineProperty(c2, a2, {
                  configurable: true,
                  writable: true,
                  value: b2
                });
              ...
              $jscomp.polyfillIsolated = function(a2, b2, c2, d2) {
                ...
                b2 = b2(c2);
                null != b2 && (a2 ? $jscomp.defineProperty($jscomp.polyfills, e2, {
                  configurable: true,
                  writable: true,
                  value: b2
                }) : b2 !== c2 && ($jscomp.propertyToPolyfillSymbol[e2] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(e2) : $jscomp.POLYFILL_PREFIX + e2, e2 = $jscomp.propertyToPolyfillSymbol[e2], $jscomp.defineProperty(d2, e2, {
                  configurable: true,
                  writable: true,
                  value: b2
                })));
              ...
              $jscomp.polyfill("Symbol.iterator", function(a2) {
                ...
                for (var b2 = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c2 = 0; c2 < b2.length; c2++) {
                  ...
                  "function" === typeof d2 && "function" != typeof d2.prototype[a2] && $jscomp.defineProperty(d2.prototype, a2, {
                    configurable: true,
                    writable: true,
                    value: function() {
              ...
              goog.loadModule = function(a2) {
                ...
                try {
                  ...
                  if ("string" === typeof e2 && e2) goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(e2, d2, c2 !== d2) : goog.SEAL_MODULE_EXPORTS && Object.seal && "object" == typeof d2 && null != d2 && Object.seal(d2), goog.loadedModules_[e2] = {
                    exports: d2,
                    type: goog.ModuleType.GOOG,
              ...
              function module$contents$goog$array_stableSort(a2, b2) {
                for (var c2 = Array(a2.length), d2 = 0; d2 < a2.length; d2++) c2[d2] = {
                  index: d2,
                  value: a2[d2]
                };
              ...
              goog.labs.userAgent.browser.getIEVersion_ = function(a2) {
                ...
                if (c2 && c2[1]) if (a2 = /Trident\/(\d.\d)/.exec(a2), "7.0" == c2[1]) {
              ...
              goog.html.SafeHtml.createIframe = function(a2, b2, c2, d2) {
                ...
                a2 = goog.html.SafeHtml.combineAttributes(e2, {
                  sandbox: ""
                }, c2);
              ...
              goog.html.SafeHtml.createStyle = function(a2, b2) {
                b2 = goog.html.SafeHtml.combineAttributes({
                  type: "text/css"
                }, {}, b2);
                var c2 = "";
                a2 = module$contents$goog$array_concat(a2);
              ...
              goog.html.SafeHtml.getAttrNameAndValue_ = function(a2, b2, c2) {
                if (c2 instanceof goog.string.Const) c2 = goog.string.Const.unwrap(c2);
                  ...
                  if (goog.html.SafeHtml.SUPPORT_STYLE_ATTRIBUTE) c2 = goog.html.SafeHtml.getStyleValue_(c2);
              ...
              goog.string.unescapeEntitiesUsingDom_ = function(a2, b2) {
                ...
                return a2.replace(goog.string.HTML_ENTITY_PATTERN_, function(e2, f2) {
                  ...
                  g2 || (goog.dom.safe.setInnerHtml(d2, goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("Single HTML entity."), e2 + " ")), g2 = d2.firstChild.nodeValue.slice(0, -1));
                  return c2[e2] = g2;
                });
              };
              ...
              i18n.phonenumbers.NumberFormat.prototype.getDescriptor = function() {
                ...
                a2 || (i18n.phonenumbers.NumberFormat.descriptor_ = a2 = goog.proto2.Message.createDescriptor(i18n.phonenumbers.NumberFormat, {
                  0: {
                    name: "NumberFormat",
              ...
              i18n.phonenumbers.PhoneMetadataCollection.prototype.getDescriptor = function() {
                ...
                a2 || (i18n.phonenumbers.PhoneMetadataCollection.descriptor_ = a2 = goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneMetadataCollection, {
                  0: {
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.formatByPattern = function(a2, b2, c2) {
                ...
                if (null != g2) {
                  ...
                  if (0 < g2.length) {
                    ...
                    0 < h.length ? (g2 = g2.replace(i18n.phonenumbers.PhoneNumberUtil.NP_PATTERN_, h).replace(i18n.phonenumbers.PhoneNumberUtil.FG_PATTERN_, "$1"), c2.setNationalPrefixFormattingRule(g2)) : c2.clearNationalPrefixFormattingRule();
                  }
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.formatNationalNumberWithCarrierCode = function(a2, b2) {
                ...
                return this.prefixNumberWithCountryCallingCode_(c2, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, b2, a2);
              };
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryCallingNumber = function(a2, b2) {
                ...
                } else if (c2 == this.getCountryCodeForValidRegion_(b2)) return this.format(a2, i18n.phonenumbers.PhoneNumberFormat.NATIONAL);
                ...
                a2 = this.maybeGetFormattedExtension_(a2, e2, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL);
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryKeepingAlphaChars = function(a2, b2) {
                ...
                b2 = "";
                null != f2 && (b2 = f2.getInternationalPrefixOrDefault(), b2 = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_, b2) ? b2 : f2.getPreferredInternationalPrefixOrDefault());
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function(a2, b2, c2, d2, e2) {
                ...
                if (null != b2) {
                  ...
                  if (goog.string.startsWith(h, g2) && (g2 = new goog.string.StringBuffer(h.substring(g2.length)), h = b2.getGeneralDesc(), h = new RegExp(h.getNationalNumberPatternOrDefault()), this.maybeStripNationalPrefixAndCarrierCode(g2, b2, null), g2 = g2.toString(), !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, a2.toString()) && i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(h, g2) || this.testNumberLength_(a2.toString(), b2) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_LONG)) return c2.append(g2), d2 && e2.setCountryCodeSource(i18n.phonenumbers.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITHOUT_PLUS_SIGN), e2.setCountryCode(f2), f2;
                }
                e2.setCountryCode(0);
                return 0;
              };
              ...
              i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function(a2, b2, c2, d2) {
                ...
                try {
                  ...
                  if (k.message == i18n.phonenumbers.Error.INVALID_COUNTRY_CODE && i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(h)) {
                    if (h = h.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, ""), g2 = this.maybeExtractCountryCode(h, f2, a2, c2, d2), 0 == g2) throw k;
                  } else throw k;
                }
              ...
              i18n.phonenumbers.ShortNumberInfo.prototype.getExpectedCostForRegion = function(a2, b2) {
                ...
                a2 = this.getNationalSignificantNumber_(a2);
                return d2.getGeneralDesc().possibleLengthArray().includes(a2.length) ? this.matchesPossibleNumberAndNationalNumber_(a2, d2.getPremiumRate()) ? c2.PREMIUM_RATE : this.matchesPossibleNumberAndNationalNumber_(a2, d2.getStandardRate()) ? c2.STANDARD_RATE : this.matchesPossibleNumberAndNationalNumber_(a2, d2.getTollFree()) || this.isEmergencyNumber(a2, b2) ? c2.TOLL_FREE : c2.UNKNOWN_COST : c2.UNKNOWN_COST;
              };
  ...
  */
  init() {
    ...
    if (this.onlyCountries.length) {
      this.allCountries = this.allCountries.filter((c2) => this.onlyCountries.includes(c2.iso2));
    }
  ...
  searchCountry() {
    ...
    const country = this.allCountries.filter((c2) => {
      if (this.searchCountryField.indexOf(SearchCountryField.All) > -1) {
        if (c2.iso2.toLowerCase().startsWith(countrySearchTextLower)) {
          return c2;
        }
        if (c2.name.toLowerCase().startsWith(countrySearchTextLower)) {
          return c2;
        }
        if (c2.dialCode.startsWith(this.countrySearchText)) {
          return c2;
        }
      } else {
  ...
  onPhoneNumberChange() {
    ...
    if (this.enableAutoCountrySelect) {
      ...
      if (countryCode && countryCode !== this.selectedCountry.iso2) {
        const newCountry = this.allCountries.slice().sort((a2, b2) => {
          return a2.priority - b2.priority;
        }).find((c2) => c2.iso2 === countryCode);
        if (newCountry) {
  ...
  getCountryIsoCode(countryCode, number) {
    ...
    const countries = this.allCountries.filter((c2) => c2.dialCode === countryCode.toString());
    const mainCountry = countries.find((c2) => c2.areaCodes === void 0);
    const secondaryCountries = countries.filter((c2) => c2.areaCodes !== void 0);
  ...
  fetchCountryData() {
    this.allCountries = [];
    this.countryCodeData.allCountries.forEach((c2) => {
      const country = {
        name: c2[0].toString(),
        iso2: c2[1].toString(),
        dialCode: c2[2].toString(),
        priority: +c2[3] || 0,
        areaCodes: c2[4] || void 0,
        htmlId: `iti-0__item-${c2[1].toString()}`,
        flagClass: `iti__${c2[1].toString().toLocaleLowerCase()}`,
        placeHolder: ""
      };
  ...
  updatePreferredCountries() {
    if (this.preferredCountries.length) {
      ...
      this.preferredCountries.forEach((iso2) => {
        const preferredCountry = this.allCountries.filter((c2) => {
          return c2.iso2 === iso2;
        });
  ...
  updateSelectedCountry() {
    if (this.selectedCountryISO) {
      this.selectedCountry = this.allCountries.find((c2) => {
        return c2.iso2.toLowerCase() === this.selectedCountryISO.toLowerCase();
      });
